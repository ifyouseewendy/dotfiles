...
function josh_prompt {
  ...
  prompt="%{$fg_bold[red]%}➜  wendi-mac%{$fg_bold[green]%}%p %{$fg[cyan]%}%~ %{$fg_bold[blue]%}$(git_prompt_info)%{$fg_bold[blue]%}$prompt%{$fg_bold[red]%}$(rvm_prompt_info || rbenv_prompt_info)%{$fg_bold[red]%}"
